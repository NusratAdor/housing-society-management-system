...
//
// CHANGE (this pass): migrated fully off the old isCreditDeposit boolean
// (a payment was either ENTIRELY a deposit or ENTIRELY a charges
// payment) onto Payment.advanceAmount — a portion of a single payment's
// total. This is what actually allows "pay this month's due AND prepay
// two months ahead" in one transaction, which the boolean design could
// never represent.
//
...
// two already-existing collections — no separate ledger model needed:
//
...
// new due. PaymentAllocation's existing meaning never changes.
...
//
// A MonthlyCharge is only ever fully cleared here, never partially. If
// total available credit is less than the charge amount, nothing is
// applied; the credit stays banked for a future, smaller charge.
//
