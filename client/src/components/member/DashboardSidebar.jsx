    ...
    <aside className="hidden lg:flex flex-col w-[220px] flex-shrink-0
      ...
      <nav className="flex-1 py-3 px-3 space-y-0.5 overflow-y-auto">
        ...
        <div className="pt-2 pb-1">
          <p className="text-[10px] text-gray-400 uppercase tracking-widest font-medium px-3">
            Community
          </p>
        </div>
      ...
      <div className="px-4 pb-5 pt-3 border-t border-gray-100 space-y-2.5">
        <div className="px-3 py-2.5 rounded-xl bg-gray-50 border border-gray-100">
          ...
          {memberSinceStr ? (
            <p className="text-xs font-semibold text-gray-700">{memberSinceStr}</p>
          ) : (
