...
// near the other small components / just above ProtectedRoute
  ...
  <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
    <div className="max-w-md text-center bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
      ...
      <p className="text-sm text-gray-500">
        This membership is no longer active. If you believe this is a mistake,
...
const ProtectedRoute = ({ children, allowedRoles }) => {
  ...
  const { memberProfile, loadingProfile, staffProfile, loadingStaffProfile } =
    useAppContext();
  ...
  if (staffProfile) {
    ...
    const fallback =
      staffProfile.role === "super_admin" ? "/super-admin" : "/admin";
  ...
  if (memberProfile.status !== "active") {
    // NEW
    return <MembershipRemovedScreen />; // NEW
  }
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <Routes location={location} key={location.pathname}>
                ...
                />
                <Route
                  path="/about-us/advisers"
                  element={<CommitteeSection category="adviser" />}
                />
                <Route
                  path="/about-us/chairman"
                  element={<CommitteeSection category="chairman" />}
                />
                <Route
                  path="/about-us/general-secretary"
                  element={<CommitteeSection category="generalSecretary" />}
                />
                <Route
                  path="/about-us/former-chairman"
                  element={<CommitteeSection category="formerChairman" />}
                />
                <Route
                  path="/about-us/former-general-secretary"
                  element={
                    <CommitteeSection category="formerGeneralSecretary" />
                  }
                />
                <Route
                  path="/about-us/executive-committee"
                  element={<CommitteeSection category="executiveCommittee" />}
                />
                <Route
                  path="/about-us/member/:id"
                  element={<CommitteeMemberDetail />}
                />
